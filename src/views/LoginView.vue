        ...
        <div class="mx-auto w-[458px] h-[950px] bg-slate-300 rounded-[40px] border-[24px] border-black">
            ...
            <div class="flex justify-center items-center pt-[40px]">
                <span>
                    ...
                    <svg width="160px" height="160px" viewBox="0 0 24 24" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>alarm_2_line</title>
                        <g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Device" transform="translate(-96.000000, 0.000000)" fill-rule="nonzero">
                                <g id="alarm_2_line" transform="translate(96.000000, 0.000000)">
                                    <path
